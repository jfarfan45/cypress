...
describe('Visitar Viajemos.com', () => {
  ...
  it('Escoger  destino ', () => {
    //introducir destino
    cy.get('input[class="inp-text__input inp-text__input--secondary pickupLocation ui-autocomplete-input"]').type("toronto").wait(3000)
  ...
  it('pago', () =>{
    cy.get('img[alt="Avis"]').eq(0).click().wait(500);
